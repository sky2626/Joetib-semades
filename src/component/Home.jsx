           ...
           {/*  Hero section */}
            ...
            className="bg-gradient-to-l from-pro-300 flex flex-col md:flex-row gap-1" >
                <div className="flex flex-col justify-center p-12 md:pl-28 ">
                    ...
                    className="text-white bg-pro-100 h-10 rounded-lg mt-10 md:w-120 ">
                        {showMore ? 'Hide' : 'Show'} details
                    </button>
                    {showMore && 
                    <p 
                    className='bg-pro-300 mt-0 p-4 text-white rounded-lg md:w-120 transition duration-700 ease-in-out'>
